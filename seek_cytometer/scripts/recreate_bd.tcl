...
################################################################
# This is a generated script based on design: cytometer_platform
#
...
# source cytometer_platform_script.tcl
...
xilinx.com:user:signal_analyzer:1.0\
xilinx.com:user:ad_sample:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  set ad7606c_port [ create_bd_intf_port -mode Slave -vlnv kissfire.icu:user:ad7606c_port_rtl:1.0 ad7606c_port ]


  # Create ports
  set drive_level_out [ create_bd_port -dir O drive_level_out ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#######SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART\
1#UART 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#I2C 1#I2C 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PCIE#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#USB0 Reset#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD\
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins ad_sample_0/S00_AXI]
  ...
  connect_bd_net -net ad_sample_0_ad_ch1_val [get_bd_pins ad_sample_0/ad_ch1_val] [get_bd_pins signal_analyzer_0/ad_ch1_val]
  connect_bd_net -net ad_sample_0_ad_ch2_val [get_bd_pins ad_sample_0/ad_ch2_val] [get_bd_pins signal_analyzer_0/ad_ch2_val]
  connect_bd_net -net ad_sample_0_ad_ch3_val [get_bd_pins ad_sample_0/ad_ch3_val] [get_bd_pins signal_analyzer_0/ad_ch3_val]
  connect_bd_net -net ad_sample_0_ad_ch4_val [get_bd_pins ad_sample_0/ad_ch4_val] [get_bd_pins signal_analyzer_0/ad_ch4_val]
  connect_bd_net -net ad_sample_0_ad_ch5_val [get_bd_pins ad_sample_0/ad_ch5_val] [get_bd_pins signal_analyzer_0/ad_ch5_val]
  connect_bd_net -net ad_sample_0_ad_ch6_val [get_bd_pins ad_sample_0/ad_ch6_val] [get_bd_pins signal_analyzer_0/ad_ch6_val]
  connect_bd_net -net ad_sample_0_ad_ch7_val [get_bd_pins ad_sample_0/ad_ch7_val] [get_bd_pins signal_analyzer_0/ad_ch7_val]

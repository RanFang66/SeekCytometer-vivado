...
#
# create_project.tcl: Tcl script for re-creating project 'seek_cytometer'
#
# Generated by Vivado on Tue Jun 02 10:32:07 +0800 2026
...
#
#    "E:/seek_cytometer/hardware/scripts/seek_cytometer/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "E:/seek_cytometer/hardware/seek_cytometer/seek_cytometer.srcs/constrs_1/imports/new/ad7606.xdc"
#    "E:/seek_cytometer/hardware/seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"
#    "E:/seek_cytometer/hardware/seek_cytometer/seek_cytometer.srcs/constrs_1/new/sorter.xdc"
#    "E:/seek_cytometer/hardware/seek_cytometer/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/seek_cytometer/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/imports/new/ad7606.xdc"]"\
 "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"]"\
 "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/sorter.xdc"]"\
 "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../ip_repo/signal_analyzer_1_0"]"]"\
 "[file normalize "$origin_dir/../ip_repo/ad_sample_1_0"]"]"\
 "[file normalize "$origin_dir/../interfaces"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "seek_cytometer"
...
set orig_proj_dir "[file normalize "$origin_dir/seek_cytometer"]"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu2cg-sfvc784-1-e
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ip_repo/signal_analyzer_1_0"] [file normalize "$origin_dir/../ip_repo/ad_sample_1_0"] [file normalize "$origin_dir/../interfaces"]" $obj
...
set_property -name "top" -value "cytometer_platform_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/imports/new/ad7606.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/imports/new/ad7606.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/sorter.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/sorter.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"]" -objects $obj
set_property -name "target_part" -value "xczu2cg-sfvc784-1-e" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../seek_cytometer/seek_cytometer.srcs/constrs_1/new/debug_core.xdc"]" -objects $obj
...
set file "$origin_dir/../seek_cytometer/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp"
set file [file normalize $file]
...
set file "synth_1/cytometer_platform_wrapper.dcp"
set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
set_property -name "netlist_only" -value "0" -objects $file_obj
...
# Proc to create BD cytometer_platform
proc cr_bd_cytometer_platform { parentCell } {
...
# End of cr_bd_cytometer_platform()
cr_bd_cytometer_platform ""
set_property REGISTERED_WITH_MANAGER "1" [get_files cytometer_platform.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files cytometer_platform.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse cytometer_platform.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../seek_cytometer/seek_cytometer.gen/sources_1/bd/cytometer_platform/hdl/cytometer_platform_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse cytometer_platform.bd] -top]
...
set obj [get_runs synth_1]
set_property -name "part" -value "xczu2cg-sfvc784-1-e" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/seek_cytometer.srcs/utils_1/imports/synth_1/cytometer_platform_wrapper.dcp" -objects $obj
